<template>
	<div class="diy_details page_rescue_station_information" id="rescue_station_information_details">
		<div class='warp'>
			<div class='container'>
				<div class='row'>
					<div class='col'>
						<div class='card_rescue_station_information'>
							<div_rescue_station_information :obj="obj"></div_rescue_station_information>
						</div>
					</div>
				</div>
			</div>
...
<script>
	import div_rescue_station_information from "@/components/diy/div_rescue_station_information.vue";
	import mixin from "@/mixins/page.js";
	export default {
		mixins:[mixin],
		components:{
			div_rescue_station_information
		},
		data(){
			return{
				...
				query: {
					...
					"capacity_of_rescue_station": "",
					"address_of_rescue_station": "",
					"person_in_charge": "",
					"contact_information": "",
					"rescue_station_picture": "",
		...
		methods:{
			...
			get_collect(obj) {
				...
				var query = {
					...
					source_id: obj["rescue_station_information_id"],
					user_id
				};
