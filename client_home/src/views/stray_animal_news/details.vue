<template>
	<div class="diy_details page_stray_animal_news" id="stray_animal_news_details">
		<div class='warp'>
			<div class='container'>
				<div class='row'>
					<div class='col'>
						<div class='card_stray_animal_news'>
							<div_stray_animal_news :obj="obj"></div_stray_animal_news>
						</div>
					</div>
				</div>
			</div>
...
<script>
	import div_stray_animal_news from "@/components/diy/div_stray_animal_news.vue";
	import mixin from "@/mixins/page.js";
	export default {
		mixins:[mixin],
		components:{
			div_stray_animal_news
		},
		data(){
			return{
		...
		methods:{
			...
			get_collect(obj) {
				...
				var query = {
					...
					source_field: "stray_animal_news_id",
					source_id: obj["stray_animal_news_id"],
					user_id
				};
		 ...
		 /****
			...
			change_collect() {
				...
				var query = {
					source_table: "stray_animal_news",
					source_field: "stray_animal_news_id",
					source_id: this.obj["stray_animal_news_id"],
					user_id
				};
				...
				if (this.state_praise) {
					...
					this.$get('~/api/praise/del?', query, (res) => {
						if(res.result){
							...
							this.$post('~/api/stray_animal_news/set?stray_animal_news_id=' + _this.obj["stray_animal_news_id"], {
								praise_len
							}, (res) => {
								if(res.result){
