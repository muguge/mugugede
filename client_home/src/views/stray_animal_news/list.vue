<template>
	<div class="diy_list page_stray_animal_news" id="stray_animal_news_list">
		<div class="warp">
			<div class="container diy_list_container">
				<div class="diy_list_title">
					<div class="col">
						<span class="title">流浪动物消息列表</span>
					</div>
				</div>
				...
				<div class="row diy_list_box">
					<div class="col">
						<!-- 列表 -->
						<list_stray_animal_news :list="list" />
						<!-- /列表 -->
					</div>
				</div>
...
<script>
	import list_stray_animal_news from "@/components/diy/list_stray_animal_news.vue";
