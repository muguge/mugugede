<template>
	<div class="diy_details_box diy_div_rescue_station_information">
		<div class="warp">
			<div class="container">
		...
		methods: {
			...
			change_praise(obj) {
				...
				var query = {
					...
					source_field: "rescue_station_information_id",
					source_id: this.obj["rescue_station_information_id"],
					user_id
				};
				...
				if (this.state_praise) {
					...
					this.$get('~/api/praise/del?', query, (res) => {
						if(res.result){
							...
							this.$post('~/api/rescue_station_information/set?rescue_station_information_id=' + _this.obj["rescue_station_information_id"], {
								praise_len
							}, (res) => {
								if(res.result){
